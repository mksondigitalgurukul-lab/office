...
?>
  ...
  <p style="color:var(--color-text-muted);">Showing the most recent 60 records.</p>
  ...
  <div class="overflow-x">
    <table class="db-table">
      ...
      <tbody>
        <?php if (!$history): ?>
          <tr><td colspan="7" style="color:var(--color-text-muted);">No attendance records yet.</td></tr>
        <?php endif; ?>
